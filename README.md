...
![image](https://github.com/user-attachments/assets/66b56f2b-65c8-410d-9659-4befc370a6a7)
...
Кроме основных есть ещё большое количество скрытых, которое можно посмотреть через [OGame API](#api), далее по тексту они упоминаются как "скрытая настройка сервера".
